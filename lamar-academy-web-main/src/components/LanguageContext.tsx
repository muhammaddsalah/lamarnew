...
const translations = {
  ar: {
    ...
    'welcome.desc': 'منصتكم الشاملة للتعلّم والتطوير من مرحلة التأسيس وحتى الثانوية العامة، بالإضافة إلى برامج متكاملة في اللغات، البرمجة، وتحفيظ القرآن، بإشراف أمهر المعلمين والمتخصصين.',
    'address.title': 'مقراتنا',
    'address.1': 'الفلل قبل كوبرى الفحص',
    'address.2': 'شارع تجاره',
    ...
    'why.reason1': 'تعليم متميز من التأسيس إلى الثانوية',
    'why.reason2': 'مدربون معتمدون وأكفاء',
    'why.reason3': 'برامج تعليمية شاملة ومتجددة',
    'why.reason4': 'دعم نفسي وتربوي للطلاب',
    'why.reason5': 'بيئة تعليمية مشجعة وآمنة',
