...
const translations: Translations = {
  ar: {
    ...
    'section.quran.desc': 'نُحفّظ أبناءنا القرآن الكريم بأسلوب محبب وتفاعلي، مع المراجعة والمتابعة المستمرة، بالإضافة إلى تعليم تعاليم وآداب الدين، كيفية الصلاة والوضوء، وأحكام التجويد بشكل مبسط وعملي.',
